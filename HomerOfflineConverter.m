...
%This function converts recorded NIRx datasets into Homer2 format
%(*.nirs)cd
...
try
    files = rdir(fullfile(pathname,filesep,'*.wl1'));
    %files = dir('/Users/fcnlab/Desktop/2018-10-08_001/NIRS-2018-10-08_001.wl1');
catch
    disp('Alert: rdir Matlab function not available. Trying to load single dataset instead.');
    files = dir([pathname filesep '*.wl1']);
     %files =
     %dir('/Users/fcnlab/Desktop/2018-10-08_001/NIRS-2018-10-08_001.wl1');
     %AJD 4/17/2019
    if isempty(files)
